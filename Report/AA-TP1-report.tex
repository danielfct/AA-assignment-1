...
To set the parameter $h$, once again a $5$-fold stratified cross validation was implemented. Notice that in this case a smaller bandwidth allows for lesser bias and greater variance.
